...
function clickRight() {
  ...
  switch(newValue){
    case -270:
      ...
      document.querySelector(".project4-container").removeAttribute("aria-hinden");
      break;
    case -540:
      ...
      document.querySelector(".project5-container").removeAttribute("aria-hinden");
      break;
    default:
      break;
  };
...
function validateForm(e) {
  ...
  if (nameField.value === "") {
    document.getElementById("name-error").innerHTML = "Es necesario un nombre";
  } else {
    showNotification();
  }
}
